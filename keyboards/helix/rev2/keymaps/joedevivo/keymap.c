...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
    ...
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    SPCMAC, SPCMAC, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,\
    KC_LEFT, KC_RIGHT,KC_LALT, KC_LGUI, LOWER,   KC_BSPC, KC_DEL, KC_ENT, KC_SPC,  RAISE,   KC_MEH,  SPCMAC,  KC_DOWN, KC_UP \
  ),
