...
#define COLE 1 // Hardware Colemak
 ...
 * I use this with os driven Colemak, so this layout reflects Qwerty. As such,
 * I've moved some secondary functions around from the defaults.
 *
 * Also went with Kinesis style thumb clusters, becaus that's what I'm used to.
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_F1,          KC_QUOT,      KC_LSFT,  KC_LEFT,KC_RGHT,
                                                      KC_ESC, KC_F2,
                                                              KC_HOME,
        ...
        // right hand
             ...
             KC_F6       ,KC_N,   KC_M,  KC_COMM,KC_DOT, KC_SLSH,         KC_RSFT,
                                  KC_UP, KC_DOWN,KC_LBRC,KC_RBRC,          KC_F3,
             KC_F4,KC_F5,
             KC_PGUP,
             KC_PGDOWN,KC_F8,KC_SPACE
    ),
[COLE] = KEYMAP(  // layer 1 : Hardware Colemak
        // left hand
        KC_EQL,         KC_1,         KC_2,   KC_3,   KC_4,   KC_5,   KC_LEFT,
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
    ...
    case COLEMAK:
      if (record->event.pressed) {
        persistant_default_layer_set(1UL<<COLE);
      }
      return false;
      break;
  }
