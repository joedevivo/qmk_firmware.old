...
[_LOWER] = LAYOUT_ergodox(
    // left hand
    _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   ______,
    KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, ______,
    KC_DEL,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,
    _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  ______,
    _______, _______, _______, _______, ______,
                                                _______, _______,
                                                         _______,
                                       _______, _______, _______,
    // right hand
    ______, KC_F6,   KC_F7,      KC_F8,      KC_F9,   KC_F10,  _______,
    ______, KC_CIRC, KC_AMPR,    KC_ASTR,    KC_LPRN, KC_RPRN, _______,
            KC_F6,   KC_UNDS,    KC_PLUS,    KC_LCBR, KC_RCBR, KC_PIPE,
    ______, KC_F12,  S(KC_NUHS), S(KC_NUBS), KC_HOME, KC_END,  _______,
...
[_RAISE] = LAYOUT_ergodox(
    // left hand
    _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   ______,
    KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    ______,
    KC_DEL,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,
    _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  ______,
    _______, _______, _______, _______, ______,
                                                _______, _______,
    ...
    // right hand
    ______, KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  _______,
    ______, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    _______,
            KC_F6,   KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS,
    ______, KC_F12,  KC_NUHS, KC_NUBS, KC_PGUP, KC_PGDN, _______,
                     XXXXXX,  KC_VOLD, KC_VOLU, KC_MNXT, KC_MPLY,
    ______, ______,
    ______,
