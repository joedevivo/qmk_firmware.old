...
[_QWERTY] = KEYMAP(  // layer 0 : default
    ...
    KC_LSFT,  ALT_T(KC_Z), KC_X,    KC_C,    KC_V,    KC_B,    XXXXXXX,
    ADJUST,   KC_GRV,      KC_MEH,  KC_LEFT, KC_RGHT,
                                                       KC_LGUI, KC_LALT,
                                                                KC_HOME,
                                LT(_LOWER, KC_BSPACE), KC_DELETE, LOWER,
    // right hand
    // Lightcycle Test -
    //  XXXXXXX,  KC_6,    KC_7,    KC_8,    KC_9,    KC_0,           KC_MINS,
        ...
        XXXXXXX,  KC_N,    KC_M,    KC_COMM, KC_DOT,  ALT_T(KC_SLSH), KC_RSFT,
                            KC_UP,   KC_DOWN, KC_LBRC, KC_RBRC,        XXXXXXX,
        KC_LCTL, KC_LGUI,
        KC_PGUP,
        RAISE, KC_ENTER, LT(_RAISE, KC_SPACE)
    ),
