...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = { /* qwerty */
    ...
    { KC_LSFT,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    LTHUMBO,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT },
    { ADJUST,   KC_MEH,  KC_LALT, KC_LGUI, LTHUMBI, KC_BSPC, RTHUMBO,  KC_SPC,  RTHUMBI, KC_LEFT, KC_UP,   KC_DOWN, KC_RGHT }
  },
  ...
  [_RAISE] = {
    ...
    { _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   XXXXXXX, KC_F6,   KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS },
    { _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  XXXXXXX, KC_F12,  KC_NUHS, KC_NUBS, _______, _______, _______ },
    { _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY }
  },
