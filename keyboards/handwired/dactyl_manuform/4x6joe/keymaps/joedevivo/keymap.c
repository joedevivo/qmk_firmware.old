...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT_4x6( \
    ...
    KC_LSFT, KC_Z, KC_X,    KC_C,    KC_V,  KC_B,                                      KC_N,   KC_M,  KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, \
                   KC_LEFT, KC_RIGHT,LOWER, KC_BSPC, KC_DEL, KC_LGUI, KC_RGUI, KC_ENT, KC_SPC, RAISE, KC_DOWN, KC_UP, \
  ...
  [_ADJUST] = LAYOUT_4x6( \
    ...
    _______, _______, _______, _______, _______, _______,             _______, _______, RGB_SMOD,RGB_HUD, RGB_SAD, RGB_VAD, \
                      KC_VOLD, KC_VOLU, _______, _______, _, _, _, _, _______, _______, KC_MNXT, KC_MPLY, \
                                                          _, _, _, _ \
  )
};
