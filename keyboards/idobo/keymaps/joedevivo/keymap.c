...
[_QWERTY] = LAYOUT_ortho_5x15(
  ...
  CTL_ESC, KC_A,    KC_S,    MOUSED,  ARROWF,  KC_G,    KC_P4, KC_P5, KC_P6,  KC_H,   KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,
  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_P1, KC_P2, KC_P3,  KC_N,   KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
  _,       KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_BSPC, KC_DEL,KC_MEH,KC_ENT, KC_SPC, RAISE,   KC_RGUI, KC_RALT, KC_RCTL, KC_UP
),
