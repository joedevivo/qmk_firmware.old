...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 [_QWERTY] = LAYOUT_ortho_5x15( \
    ...
    KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,      KC_LBRC, KC_END, KC_RBRC, KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,     KC_BSLS,
    ...
    KC_LEFT, KC_RIGHT,KC_LALT, KC_LGUI, MO(_LOWER),KC_BSPC, KC_DEL, KC_SPC,  KC_ENT,  KC_SPC,  MO(_RAISE), KC_MEH,  SPCMAC,  KC_DOWN, KC_UP
  ),
