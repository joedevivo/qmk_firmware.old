...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT(
    ...
    KC_LEFT, KC_RGHT, KC_LALT, X,       KC_LGUI, LOWER, KC_DEL, KC_ENT, RAISE, KC_MEH,  X,       SPCMAC,  KC_DOWN, KC_UP,
...
[_LOWER] = LAYOUT(
    ...
    _______, _______, _______, _______, _______, _______, _, _, _______, KC_MNXT,    X, KC_VOLD, KC_VOLU, KC_MPLY,
    _,_,_,KC_ENT,_,_
),
...
[_RAISE] = LAYOUT(
    ...
    _______, _______, _______, _______, _______, KC_DEL,  _,_, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY,
    _,_,KC_DEL,_,_,_
),
...
[_MOUSE] = LAYOUT(
    ...
    KC_WH_L, KC_WH_R, _______, _______, _______, _______, _,_, _______, _______, _______, _______, KC_WH_D, KC_WH_U,
    _,_,_,_,_,_
),
